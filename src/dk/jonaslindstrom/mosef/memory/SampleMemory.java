...
public class SampleMemory {
  ...
  /**
   * Create a new SampleMemory object with the given capacity. Initially, all values are set to
   * zero
   */
  ...
  /**
   * Push a new value to this memory object. If the size of the memory is exceeded, the oldest
   * value
   */
