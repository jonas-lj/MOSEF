...
/**
 * Instances of this class can store a set of samples (floats) in a queue data
 * structure with fixed size. If the capacity is reached, the oldest entries are
 * replaced.
 * 
...
public class SampleMemory {
	...
	/**
	 * Push a new value to this memory object. If the size of the memory is
	 * exceeded, the oldest value is removed.
	 * 
	 * @param value
	 */
