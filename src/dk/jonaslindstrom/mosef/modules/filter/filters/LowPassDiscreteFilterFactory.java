...
/**
 * This filter is constructed by adding waves of frequencies smaller than the
 * cutoff frequency. This is simplified using the Dirichlet kernel and
 * l'Hopitals equality to the simpler form presented below.
 * 
