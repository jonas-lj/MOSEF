...
public class Output {
	...
	/**
	 * Instances of this class takes an input module and outputs it through the
	 * sound card.
	 * 
	 * @param settings
	 * @param input
	...
	public void start() {
		...
		AudioFormat audioFormat = new AudioFormat(settings.getSampleRate(), settings.getBitRate(), 1, true, true);
